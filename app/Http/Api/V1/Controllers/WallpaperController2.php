...
use App\Http\Api\V1\Transformers\WallpaperTransformer1;
...
class WallpaperController2 extends BaseController
{
    ...
    { $categories = Category::all();
	 $wallpapers = Wallpaper::where('category_id', $category_id)->orderBy('id', 'desc')->paginate(21);
        ...
        if ($category_id != 0) {
            $wallpapers = Wallpaper::where('category_id', $category_id)->orderBy('id', 'desc')->paginate(21);
            return $this->response->paginator($wallpapers, new WallpaperTransformer1())->setMeta(ApiHelper1::metaArray('获取壁纸列表成功'));
        } else {
